...
declare namespace GatsbyTypes {
  ...
  type File = Node & {
    ...
    readonly childrenImageSharp: Maybe<
      ReadonlyArray<Maybe<ImageSharp>>
    >;
  ...
  type MarkdownRemark = Node & {
    ...
    readonly headings: Maybe<
      ReadonlyArray<Maybe<MarkdownHeading>>
    >;
  ...
  type SitePluginPluginOptions = {
    ...
    readonly linkImagesToOriginal: Maybe<
      Scalars['Boolean']
    >;
    ...
    readonly disableBgImageOnAlpha: Maybe<
      Scalars['Boolean']
    >;
    ...
    readonly feeds: Maybe<
      ReadonlyArray<Maybe<SitePluginPluginOptionsFeeds>>
    >;
  ...
  type JSONQueryOperatorInput = {
    ...
    readonly in: Maybe<
      ReadonlyArray<Maybe<Scalars['JSON']>>
    >;
    readonly nin: Maybe<
      ReadonlyArray<Maybe<Scalars['JSON']>>
    >;
  ...
  type MarkdownRemarkSortInput = {
    readonly fields: Maybe<
      ReadonlyArray<Maybe<MarkdownRemarkFieldsEnum>>
    >;
    readonly order: Maybe<
      ReadonlyArray<Maybe<SortOrderEnum>>
    >;
  ...
  type Unnamed_5_Query = {
    readonly allMarkdownRemark: Pick<
  ...
  type BioQueryQueryVariables = Exact<{
    [key: string]: never;
  }>;
      ...
      readonly siteMetadata: Maybe<
        Pick<SiteSiteMetadata, 'description'> & {
          readonly author: Maybe<
            Pick<Author, 'name' | 'summary'>
          >;
          readonly social: Maybe<
            Pick<Social, 'twitter' | 'github'>
          >;
        }
      >;
    }>;
