...
type homeawayatakumaprojectacasuneTechBlogsrcpagestagsTsx1775080574QueryVariables = Exact<{
  tag: Maybe<Scalars['String']>;
}>;


type homeawayatakumaprojectacasuneTechBlogsrcpagestagsTsx1775080574Query = { readonly allMarkdownRemark: (
...
type homeawayatakumaprojectacasuneTechBlogsrcpages404Tsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type homeawayatakumaprojectacasuneTechBlogsrcpages404Tsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type homeawayatakumaprojectacasuneTechBlogsrcpagesindexTsx862560315QueryVariables = Exact<{ [key: string]: never; }>;


type homeawayatakumaprojectacasuneTechBlogsrcpagesindexTsx862560315Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
